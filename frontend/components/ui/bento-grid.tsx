        ...
        >
            ...
            <div className="group-hover/bento:translate-x-2 transition duration-200">
                <div className="flex gap-1 items-center">
                    {icon} <span className="text-sm font-sans text-neutral-600">Todo #{index}</span>
                </div>
                ...
                <Button className="mt-2 flex gap-1 font-bold w-full hover:bg-gray-200" variant='outline'>
                    <CheckCheck />
                    Mark as completed
                </Button>
            </div>
